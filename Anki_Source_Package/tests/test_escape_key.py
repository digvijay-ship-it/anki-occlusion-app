...
class EscapeKeyTests(unittest.TestCase):
    def setUp(self):
        ...
        # Patch GDrive network calls to avoid timeout during tests
        self.gdrive_cfg_patcher = patch("services.gdrive_service.GDriveService.is_configured", return_value=False)
        self.gdrive_cfg_patcher.start()
        self.gdrive_link_patcher = patch("services.gdrive_service.GDriveService.is_linked", return_value=False)
        self.gdrive_link_patcher.start()
    ...
    def tearDown(self):
        ...
        self.gdrive_cfg_patcher.stop()
        self.gdrive_link_patcher.stop()
