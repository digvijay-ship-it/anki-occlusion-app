...
class Card:
    ...
    # Sequential Chaining, Context Framing & Tier Ranking
    parent_chain_id: Optional[str] = None
    chain_order: int = 0
    context_anchor: str = ""
    trap_note: str = ""
    priority_tier: int = 1  # 1 = Core (High-Yield), 2 = Details (Elimination)

    # Interactive MCQ & Exam Paper Fields
    options: List[Dict[str, Any]] = field(default_factory=list)
    correct_option: Any = None
    solution_data: Dict[str, Any] = field(default_factory=dict)
    percent_answered_correctly: str = ""
    exam_meta: Dict[str, Any] = field(default_factory=dict)
